      ...
      >
        <div className="p-6">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-slate-700">
                <WarningIcon />
            </div>
            <div className="flex-1">
              <h2 id="confirmation-dialog-title" className="text-lg font-bold text-white">
                {title}
              </h2>
        ...
        <div className="p-4 bg-slate-900/50 border-t border-slate-700 flex justify-end items-center gap-4 rounded-b-lg">
          <button
            type="button"
            onClick={onClose}
