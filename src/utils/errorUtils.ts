 ...
 */
// FIX: Use `instanceof` type guards to safely access properties on the `error` object.
// This resolves TypeScript errors about accessing properties on a value of type `unknown`.
